        ...
        <Reveal index={index}>
            ...
            >
                ...
                <div className="order-2 flex flex-row items-center gap-3 md:order-1 md:flex-col md:items-start md:gap-1.5 md:pt-1">
                    ...
                    <span className="label md:leading-relaxed">
                        {project.platform}
                    </span>
                </div>

                <div className="order-1 min-w-0 md:order-2">
                    <h3 className="font-display text-2xl leading-tight font-semibold transition-colors group-hover:text-accent md:text-[1.75rem]">
                        {project.name}
                    </h3>
                ...
                <ArrowUpRight
                    size={20}
                    aria-hidden="true"
                    className="order-4 mt-1 hidden shrink-0 text-faint transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-accent md:block"
                />
            </Link>
        </Reveal>
    );

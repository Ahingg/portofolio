...
export function Footer() {
    return (
        <footer
            id="contact"
            className="scroll-mt-24 border-t border-line-soft pt-16 pb-14"
        >
            ...
            <p className="prose-measure mt-4 text-muted">
                Currently at the Apple Developer Academy through December 2026,
                and available for internships, part-time work and collaboration
                alongside it.
            </p>
